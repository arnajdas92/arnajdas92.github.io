...
var game = new Phaser.Game(1200, 505, Phaser.AUTO, 'flappy-bird-reborn');
...
var Scoreboard = function(game) {
  ...
  this.scoreText = this.game.add.bitmapText(680, 180, 'flappyfont', '', 18);
  this.add(this.scoreText);
  
  this.bestText = this.game.add.bitmapText(675, 230, 'flappyfont', '', 18);
...
Menu.prototype = {
  ...
  create: function() {
    ...
    this.ground = this.game.add.tileSprite(0,400, 1200,112,'ground');
    ...
    this.title = this.add.sprite(410,0,'title');
    this.titleGroup.add(this.title);
    
    /** STEP 3 **/
    // create the bird sprite 
    // and add it to the title group
    this.bird = this.add.sprite(600,5,'bird');
...
Play.prototype = {
  create: function() {
    ...
    this.ground = new Ground(this.game, 0, 400, 1200, 112);
    ...
    this.score = 0;
    this.scoreText = this.game.add.bitmapText(this.game.width/2, 10, 'flappyfont',this.score.toString(), 54);
